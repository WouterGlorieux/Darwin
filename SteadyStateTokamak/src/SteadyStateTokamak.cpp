...
//public :
   ...
   *                                   is invalid.
   */
  void calcOScore() /*throws IncompleteReactorExcpn*/ {
...
int main() {
     ...
     * related variables.
     */
    ObservableDbl oBField_ = ObservableDbl(7.);
    ObservableDbl oDensity_ = ObservableDbl(4.5);
    ObservableDbl oPaux_ = ObservableDbl(20.);
    ObservableDbl oTemperature_ = ObservableDbl(0.);
    ObservableDbl oScore_ = ObservableDbl(0.);
   // ObservableDbl oTrial_= ObservableInt(0);


    //std::cout << oTemperature_.getValue() << std::endl;
   ...
   // bpx_.init();
    ...
    std::cout << "Bisection done" << std::endl;


    //oTemperature_.setValue(bpx_.getTemperature());
    std::cout << "last temp: " << bpx_.getTemperature() << std::endl;
